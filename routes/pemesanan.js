...
router.get('/', function (req, res) {
    connection.query('SELECT b.nama_pesanan, b.fasilitas_pesanan, p.Nomor_Kamar, b.gambar, a.fasilitas FROM pemesanan b JOIN kamar p ON b.id_Kamar = p.id_Kamar JOIN fasilitas_hotel a ON b.id_fasilitas = a.id_fasilitas', function(err, rows){
        if(err){
